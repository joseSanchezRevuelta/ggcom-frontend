...
function Filter() {
    return (
        <>
            <div className="mb-5 flex justify-between w-4/5 mx-auto" data-te-input-wrapper-init id="async">
                ...
                <button type="submit" className="text-white end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-main dark:hover:bg-blue-700 dark:focus:ring-blue-800">Filter</button>
            </div>
        </>
    )
}
