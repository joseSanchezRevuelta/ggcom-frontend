...
function Footer({ width }) {
    return (
        <>
            {/* <!-- Footer container --> */}
            <footer
                className={`bg-neutral-950 text-center text-surface/75 dark:bg-neutral-950 dark:text-white/75 lg:text-left lg:${width} mx-auto mt-auto`}>
                <div
                ...
                <div className="mx-6 py-10 text-center md:text-left">
                    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="">
                            ...
                            <p>
                                At GGCOM we try to offer you the maximum possible help. This page is under development and may cause problems.
                            </p>
                        </div>
                        {/* <!-- Products section --> */}
                        <div>
                        ...
                        <div>
                            ...
                            <p className="mb-4">
                                <a href="https://restcountries.com/" target="_blank" rel="noopener noreferrer">REST Countries API</a>
                            </p>
                            <p>
                                <a href="#!">Help</a>
                            </p>
