...
import EditPasswordModal from "../EditPasswordModal/EditPasswordModal.jsx"
...
export default function EditProfile({ user_id, user_name, user_email }) {
    ...
    return (
        <>
            <EditUsernameModal openEditUsernameModal={openEditUsernameModal} setOpenEditUsernameModal={setOpenEditUsernameModal} userNameState={userNameState}/>
            <EditEmailModal openEditEmailModal={openEditEmailModal} setOpenEditEmailModal={setOpenEditEmailModal} userEmailState={userEmailState}/>
            <EditPasswordModal openEditPasswordModal={openEditPasswordModal} setOpenEditPasswordModal={setOpenEditPasswordModal} passwordState={passwordState}/>
