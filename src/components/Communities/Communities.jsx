...
function Communities(communities) {
    ...
    return (
        <>
            <div className="grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-4 lg:w-4/5 md:w-4/5 xs:w-full mx-auto overflow-hidden py-3 lg:px-3">
