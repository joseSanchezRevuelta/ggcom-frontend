    ...
    return (
        <>
            <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 xs:grid-cols-1 gap-4 lg:w-4/5 md:w-4/5 xs:w-full mx-auto">
                ...
                <CommunitySimple image={'https://media.rawg.io/media/games/910/910d547965a5c4928ca19112778a1b4f.jpg'} videogame={'Ghensin Impact'} community={'Buscamos gente para jugar rankeds dsffsd fsfds sdfsdf dsf sdf sdf fsd sdsdfsdff'} comments={'481'} members={'232'} language={'English'} />
