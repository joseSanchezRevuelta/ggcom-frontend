...
function Explore() {
    ...
    return (
        <>
            <div className='bg-neutral-950 min-h-screen items-center overflow-auto bg-[url("/img/background_phone.jpg")] lg:bg-[url("/img/w1.jpg")] bg-cover bg-center bg-fixed flex flex-col'>
