                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="text-center mb-4">
                                <button className="text-white bg-indigo-600 font-bold hover:bg-indigo-900 focus:outline-none focus:ring-blue-300 font-medium rounded-lg lg:w-1/4 px-5 py-2.5 text-center bg-main hover:bg-violet-700 focus:ring-violet-900 mr-2" onClick={handleSearch}>Apply filters</button>
                                <button className="text-white bg-indigo-600 font-bold hover:bg-indigo-900 focus:outline-none focus:ring-blue-300 font-medium rounded-lg lg:w-1/4 px-5 py-2.5 text-center bg-transparent hover:bg-violet-700 focus:ring-violet-900 border border-neutrañ-500 ml-2" onClick={clearAll}>Clear all</button>
                            </div>
                        </div>
                    </div>
                </div>
